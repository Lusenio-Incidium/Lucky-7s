...
public class BattleManager : MonoBehaviour, IBattle, ICannonKey, IButtonTrigger, IDialouge, IMinigame
{
    [System.Serializable]
    ...
    [SerializeField] Functions onMinigameWon;
    private void Start()
    {
        currentIndex = 0;
    ...
    public void onWin()
    {
        onMinigameWon = FunctionActions(onMinigameWon);
    }
